<template>
  <div class="signup">
    <h2 class="purple--text text--darken-4 text-md-center">Регистрация</h2>
    <v-form
      ...
      <v-row>
        <v-col cols="5" class="mx-auto">
          ...
          <v-text-field
            ...
            name="phone"/>
          <v-btn type="submit" color="purple" dark>Зарегистрироваться</v-btn>
          <p class="mt-15">Уже зарегистрированы? <router-link to="/signin" class="text-decoration-none">Войти</router-link></p>
        </v-col>
      </v-row>
    </v-form>
  </div>
