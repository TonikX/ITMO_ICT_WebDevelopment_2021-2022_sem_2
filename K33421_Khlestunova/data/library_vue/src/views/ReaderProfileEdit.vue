<template>
  <div class="edit">
    <h2 class="purple--text text--darken-4 text-md-center">Редактирование профиля</h2>
    <v-form
      ...
      <v-row>
        <v-col cols="5" class="mx-auto">
          ...
          <v-text-field
            ...
            name="phone"/>
          <v-btn type="submit" color="purple" dark>Сохранить</v-btn>
          <p><router-link to="/profile" style="color: purple" class="text-decoration-none">
            <v-btn class="mr-3" hight="40px" color="purple" text>
              <h3>Назад</h3>
            </v-btn>
          </router-link></p>
        </v-col>
